          ...
          <div className='-mx-4 flex flex-wrap'>
            <div className='w-full px-4 lg:w-5/12'>
              <div className='hero-content'>
                <h1 className='mb-5 text-gray-50 text-4xl font-bold !leading-[1.208]  dark:text-white sm:text-[42px] lg:text-[40px] xl:text-5xl'>
                ...
                <ul className='flex flex-wrap items-center mt-6'>
                  ...
                  <li>
                    <a
                      href='/#'
                      className='inline-flex items-center justify-center px-5 py-3 text-center text-base font-medium text-[#464646] hover:text-blue-500 dark:text-white'
                    >
                      <span className='mr-2'>
                        <svg
                          width='24'
